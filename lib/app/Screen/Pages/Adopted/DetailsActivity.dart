...
class DetailsAdapted extends GetView<AdoptedController> {
  final Pet pet;
  const DetailsAdapted(this.pet, {super.key});
      ...
      body: Container(
        ...
        child: Column(
          ...
          children: [
              ...
              children: [
                ...
                SizedBox(
                    ...
                    child: OutlinedButton(
                        onPressed: () async{
                          Users user = await Get.put(AdoptedController())
                              .fetchUserData(pet.petId);
                          Get.to(ProfileOfOther(user));
                        },
            ...
            Text(
              'Details',
              style: _textStyle(15, FontWeight.w400, color: Colors.blue),
            ),
            Row(
              children: [
                Column(
                ...
                Column(
                  ...
                  children: [
                    ...
                    Text('${pet.ageInMonths} Months',
                        style: _textStyle(12, FontWeight.w400)),
                    Text('${pet.heightInFeet} feet',
                        style: _textStyle(12, FontWeight.w400)),
  ...
  Widget _descriptionText(String title, String description) {
    return Column(
      ...
      children: [
        Text(title,
            style: _textStyle(14, FontWeight.w600, color: Colors.black)),
        Text(description,
            style: _textStyle(12, FontWeight.w400,
